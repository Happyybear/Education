...
-(void)configView{
    ...
    self.buttonA = [SexButton buttonWithType:UIButtonTypeCustom];
...
- (void)configUISetWithName:(NSString *)name Button1:(NSString *)btn1 Button2:(NSString *)btn2 Button3:(NSString *)btn3 Button4:(NSString *)btn4 Button5:(NSString *)button5{
    ...
    [self.buttonE setTitle:btn4 forState:UIControlStateNormal];
    ...
    CGSize size5 = [button5 getStringSizeWithAtteributes:@{NSFontAttributeName: [UIFont systemFontOfSize:13.0f]}];
    ...
    [self.buttonB mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(_buttonA.mas_right).with.offset(10);
        make.height.mas_equalTo(@41);
        make.top.equalTo(_name.mas_bottom).offset(3);
